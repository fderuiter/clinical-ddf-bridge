...
async def test_evaluate_epoch_activities():
    ...
    async def mock_records():
        ...
        yield {
            "epoch_id": "ep1",
            "epoch_internal_id": 10,
            "scheduled_event_id": "se1",
            "sei_internal_id": 11,
            "activity_def_id": "ad1",
            "ad_internal_id": 12,
            "items": [
        ...
        yield {
            "epoch_id": "ep2",
            "epoch_internal_id": 20,
            "scheduled_event_id": "se3",
            "sei_internal_id": 21,
            "activity_def_id": "ad3",
            "ad_internal_id": 22,
            "items": [{"item_id": "ai5", "internal_id": 104, "is_mapped": False}],
        }
        # Unmapped (no items)
        yield {
            "epoch_id": "ep3",
            "epoch_internal_id": 30,
            "scheduled_event_id": "se4",
            "sei_internal_id": 31,
            "activity_def_id": "ad4",
            "ad_internal_id": 32,
            "items": [],
...
async def test_generate_alignment_report():
    ...
    async def eval_records():
        yield {
            ...
            "activity_def_id": "ad1",
            "ad_internal_id": 12,
            "items": [{"item_id": "ai1", "internal_id": 100, "is_mapped": True}],
        }
