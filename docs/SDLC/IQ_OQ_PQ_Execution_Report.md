...
- **Total Automated Test Cases Run:** 501
- **Passed:** 501 🟢
- **Failed/Errors:** 0 🔴
- **Skipped:** 0 ⚪
...
| `test_centralized_auto_drop_workflow` | `tests.test_sdv_signoff_and_autodrop` | PRD-QRY-006 | 🟢 PASSED | < 1s |
| `test_metadata_only_edits_do_not_drop_verification` | `tests.test_sdv_signoff_and_autodrop` | PRD-QRY-006 | 🟢 PASSED | < 1s |
| `test_sdv_signoff_authorization_roles` | `tests.test_sdv_signoff_and_autodrop` | PRD-QRY-005 | 🟢 PASSED | < 1s |
| `test_sdv_signoff_coordinate_validation_failures` | `tests.test_sdv_signoff_and_autodrop` | PRD-QRY-005 | 🟢 PASSED | < 1s |
| `test_sdv_signoff_scopes_happy_paths` | `tests.test_sdv_signoff_and_autodrop` | PRD-QRY-005 | 🟢 PASSED | < 1s |
