...
current_change_reason = contextvars.ContextVar("current_change_reason", default="system_operation")
...
def audit_context_decorator(
    ...
    def decorator(func: Callable[..., Any]) -> Callable[..., Any]:
        ...
        async def async_wrapper(*args, **kwargs) -> Any:
            ...
            change_reason = change_reason_getter(*args, **kwargs) if change_reason_getter else None
            ip_address = ip_address_getter(*args, **kwargs) if ip_address_getter else None
            with audit_context(user_id=user_id, change_reason=change_reason, ip_address=ip_address):
