...
class CTMSDatabaseManager:
    ...
    def init_db(self, database_url: str, **kwargs: Any) -> None:
        """
        Initialize the async engine and session maker for the CTMS database.
        """
    ...
    def get_session_maker(self) -> async_sessionmaker[AsyncSession]:
        if not self.session_maker:
            raise Exception("CTMS database session manager is not initialized.")
